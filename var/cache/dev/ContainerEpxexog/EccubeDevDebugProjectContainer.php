...
class EccubeDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->normalizedIds = [
            ...
            'plugin\\sample\\controller\\admin\\configcontroller' => 'Plugin\\Sample\\Controller\\Admin\\ConfigController',
            'plugin\\sample\\event' => 'Plugin\\Sample\\Event',
            'plugin\\sample\\form\\extension\\customertypeextension' => 'Plugin\\Sample\\Form\\Extension\\CustomerTypeExtension',
            'plugin\\sample\\form\\extension\\entrytypeextension' => 'Plugin\\Sample\\Form\\Extension\\EntryTypeExtension',
            'plugin\\sample\\form\\type\\admin\\configtype' => 'Plugin\\Sample\\Form\\Type\\Admin\\ConfigType',
            'plugin\\sample\\form\\type\\admin\\customerranktype' => 'Plugin\\Sample\\Form\\Type\\Admin\\CustomerRankType',
            'plugin\\sample\\repository\\configrepository' => 'Plugin\\Sample\\Repository\\ConfigRepository',
            'plugin\\sample\\repository\\customerrankrepository' => 'Plugin\\Sample\\Repository\\CustomerRankRepository',
            'plugin\\sample\\repository\\master\\rankrepository' => 'Plugin\\Sample\\Repository\\Master\\RankRepository',
        ...
        $this->fileMap = [
            ...
            'Plugin\\Sample\\Controller\\Admin\\ConfigController' => 'getConfigControllerService.php',
            'Plugin\\Sample\\Event' => 'getEventService.php',
            'Plugin\\Sample\\Form\\Extension\\CustomerTypeExtension' => 'getCustomerTypeExtensionService.php',
            'Plugin\\Sample\\Form\\Extension\\EntryTypeExtension' => 'getEntryTypeExtensionService.php',
            'Plugin\\Sample\\Form\\Type\\Admin\\ConfigType' => 'getConfigTypeService.php',
            'Plugin\\Sample\\Form\\Type\\Admin\\CustomerRankType' => 'getCustomerRankTypeService.php',
            'Plugin\\Sample\\Repository\\ConfigRepository' => 'getConfigRepositoryService.php',
            'Plugin\\Sample\\Repository\\CustomerRankRepository' => 'getCustomerRankRepositoryService.php',
            'Plugin\\Sample\\Repository\\Master\\RankRepository' => 'getRankRepositoryService.php',
            ...
            'security.request_matcher.klfzksd' => 'getSecurity_RequestMatcher_KlfzksdService.php',
        ...
        $this->privates = [
            ...
            'Plugin\\Sample\\Event' => true,
            'Plugin\\Sample\\Form\\Extension\\CustomerTypeExtension' => true,
            'Plugin\\Sample\\Form\\Extension\\EntryTypeExtension' => true,
            'Plugin\\Sample\\Form\\Type\\Admin\\ConfigType' => true,
            'Plugin\\Sample\\Form\\Type\\Admin\\CustomerRankType' => true,
            'Plugin\\Sample\\Repository\\ConfigRepository' => true,
            'Plugin\\Sample\\Repository\\CustomerRankRepository' => true,
            'Plugin\\Sample\\Repository\\Master\\RankRepository' => true,
            ...
            'security.request_matcher.klfzksd' => true,
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => ($this->targetDirs[3].'/app/Plugin/Sample/Entity')]), 'Plugin\\Sample\\Entity');
        ...
        }, 'Plugin\\Sample\\Repository\\ConfigRepository' => function () {
            return ${($_ = isset($this->services['Plugin\\Sample\\Repository\\ConfigRepository']) ? $this->services['Plugin\\Sample\\Repository\\ConfigRepository'] : $this->load('getConfigRepositoryService.php')) && false ?: '_'};
        }, 'Plugin\\Sample\\Repository\\CustomerRankRepository' => function () {
            return ${($_ = isset($this->services['Plugin\\Sample\\Repository\\CustomerRankRepository']) ? $this->services['Plugin\\Sample\\Repository\\CustomerRankRepository'] : $this->load('getCustomerRankRepositoryService.php')) && false ?: '_'};
        }, 'Plugin\\Sample\\Repository\\Master\\RankRepository' => function () {
            return ${($_ = isset($this->services['Plugin\\Sample\\Repository\\Master\\RankRepository']) ? $this->services['Plugin\\Sample\\Repository\\Master\\RankRepository'] : $this->load('getRankRepositoryService.php')) && false ?: '_'};
        }])));
    ...
    {
        $this->services['twig'] = $instance = new \Twig\Environment(${($_ = isset($this->services['twig.loader']) ? $this->services['twig.loader'] : $this->getTwig_LoaderService()) && false ?: '_'}, ['paths' => [($this->targetDirs[3].'/app/Plugin/Sample/Resource/template') => 'Sample', ($this->targetDirs[3].'/app/template/'.$this->getEnv('string:ECCUBE_TEMPLATE_CODE')) => NULL, ($this->targetDirs[3].'/src/Eccube/Resource/template/default') => NULL, ($this->targetDirs[3].'/app/Plugin') => NULL, ($this->targetDirs[3].'/app/template/admin') => 'admin', ($this->targetDirs[3].'/src/Eccube/Resource/template/admin') => 'admin', ($this->targetDirs[3].'/app/template/user_data') => 'user_data', ($this->targetDirs[3].'/src/Eccube/Resource/template/toolbar') => 'toolbar', ($this->targetDirs[3].'/src/Eccube/Resource/template/common') => 'common'], 'debug' => true, 'strict_variables' => true, 'form_themes' => $this->parameters['twig.form.resources'], 'date' => ['timezone' => $this->getEnv('ECCUBE_TIMEZONE'), 'format' => 'F j, Y H:i', 'interval_format' => '%d days'], 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape' => 'name', 'cache' => ($this->targetDirs[0].'/twig'), 'charset' => 'UTF-8', 'default_path' => ($this->targetDirs[3].'/templates'), 'number_format' => ['decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',']]);
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListener('Customer/edit.twig', [0 => function () {
            return ${($_ = isset($this->services['Plugin\\Sample\\Event']) ? $this->services['Plugin\\Sample\\Event'] : $this->load('getEventService.php')) && false ?: '_'};
        }, 1 => 'CustomerEditTwig'], 0);
        $instance->addListener('kernel.response', [0 => function () {
    ...
    protected function getSecurity_Firewall_MapService()
    {
        return $this->services['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\ServiceLocator(['security.firewall.map.context.admin' => function () {
            ...
            yield 'security.firewall.map.context.admin' => ${($_ = isset($this->services['security.request_matcher.klfzksd']) ? $this->services['security.request_matcher.klfzksd'] : ($this->services['security.request_matcher.klfzksd'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/'.$this->getEnv('string:ECCUBE_ADMIN_ROUTE').'/'))) && false ?: '_'};
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/app/Plugin/Sample/Resource/template'), 'Sample');
