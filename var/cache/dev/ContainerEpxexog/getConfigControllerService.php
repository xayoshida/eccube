...
// Returns the public 'Plugin\Sample\Controller\Admin\ConfigController' shared autowired service.
...
include_once $this->targetDirs[3].'/app/Plugin/Sample/Controller/Admin/ConfigController.php';

$this->services['Plugin\\Sample\\Controller\\Admin\\ConfigController'] = $instance = new \Plugin\Sample\Controller\Admin\ConfigController(${($_ = isset($this->services['Plugin\\Sample\\Repository\\ConfigRepository']) ? $this->services['Plugin\\Sample\\Repository\\ConfigRepository'] : $this->load('getConfigRepositoryService.php')) && false ?: '_'});
