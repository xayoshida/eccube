...
class EccubeDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        elseif (0 === strpos($pathinfo, '/admin_directory')) {
            // admin_login
            if ('/admin_directory/login' === $pathinfo) {
            ...
            // admin_homepage
            if ('/admin_directory' === $trimmedPathinfo) {
            ...
            if (0 === strpos($pathinfo, '/admin_directory/s')) {
                // admin_homepage_sale
                if ('/admin_directory/sale_chart' === $pathinfo) {
                ...
                // sample_admin_config
                if ('/admin_directory/sample/config' === $pathinfo) {
                    $ret = array (  '_controller' => 'Plugin\\Sample\\Controller\\Admin\\ConfigController::index',  '_route' => 'sample_admin_config',);
                    $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                    if (!isset($requiredSchemes[$context->getScheme()])) {
                        if ('GET' !== $canonicalMethod) {
                            goto not_sample_admin_config;
                        }

                        return array_replace($ret, $this->redirect($rawPathinfo, 'sample_admin_config', key($requiredSchemes)));
                    }

                    return $ret;
                }
                not_sample_admin_config:

                if (0 === strpos($pathinfo, '/admin_directory/se')) {
                    // admin_homepage_nonstock
                    if ('/admin_directory/search_nonstock' === $pathinfo) {
                    ...
                    if ('/admin_directory/search_customer' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/admin_directory/setting/shop')) {
                        // admin_setting_shop_csv
                        if (0 === strpos($pathinfo, '/admin_directory/setting/shop/csv') && preg_match('#^/admin_directory/setting/shop/csv(?:/(?P<id>\\d+))?$#sD', $pathinfo, $matches)) {
                        ...
                        if (0 === strpos($pathinfo, '/admin_directory/setting/shop/delivery')) {
                            // admin_setting_shop_delivery
                            if ('/admin_directory/setting/shop/delivery' === $pathinfo) {
                            ...
                            if ('/admin_directory/setting/shop/delivery/new' === $pathinfo) {
                            ...
                            if (preg_match('#^/admin_directory/setting/shop/delivery/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/admin_directory/setting/shop/delivery/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/admin_directory/setting/shop/delivery/(?P<id>\\d+)/visibility$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/admin_directory/setting/shop/delivery/sort_no/move' === $pathinfo) {
                        ...
                        elseif (0 === strpos($pathinfo, '/admin_directory/setting/shop/mail')) {
                            // admin_setting_shop_mail
                            if ('/admin_directory/setting/shop/mail' === $pathinfo) {
                            ...
                            if (preg_match('#^/admin_directory/setting/shop/mail/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/admin_directory/setting/shop/mail/preview' === $pathinfo) {
                        ...
                        elseif (0 === strpos($pathinfo, '/admin_directory/setting/shop/payment')) {
                            // admin_setting_shop_payment
                            if ('/admin_directory/setting/shop/payment' === $pathinfo) {
                            ...
                            if ('/admin_directory/setting/shop/payment/new' === $pathinfo) {
                            ...
                            if (preg_match('#^/admin_directory/setting/shop/payment/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/admin_directory/setting/shop/payment/image/add' === $pathinfo) {
                            ...
                            if (preg_match('#^/admin_directory/setting/shop/payment/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/admin_directory/setting/shop/payment/(?P<id>\\d+)/visible$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/admin_directory/setting/shop/payment/sort_no/move' === $pathinfo) {
                        ...
                        // admin_setting_shop
                        if ('/admin_directory/setting/shop' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/admin_directory/setting/shop/tax')) {
                            // admin_setting_shop_tax
                            if ('/admin_directory/setting/shop/tax' === $pathinfo) {
                            ...
                            if ('/admin_directory/setting/shop/tax/new' === $pathinfo) {
                            ...
                            if (preg_match('#^/admin_directory/setting/shop/tax/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    elseif (0 === strpos($pathinfo, '/admin_directory/setting/system')) {
                        // admin_setting_system_authority
                        if ('/admin_directory/setting/system/authority' === $pathinfo) {
                        ...
                        if ('/admin_directory/setting/system/log' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/admin_directory/setting/system/masterdata')) {
                            // admin_setting_system_masterdata
                            if ('/admin_directory/setting/system/masterdata' === $pathinfo) {
                            ...
                            if (preg_match('#^/admin_directory/setting/system/masterdata/(?P<entity>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/admin_directory/setting/system/masterdata/edit' === $pathinfo) {
                        ...
                        elseif (0 === strpos($pathinfo, '/admin_directory/setting/system/member')) {
                            // admin_setting_system_member
                            if ('/admin_directory/setting/system/member' === $pathinfo) {
                            ...
                            if ('/admin_directory/setting/system/member/new' === $pathinfo) {
                            ...
                            if (preg_match('#^/admin_directory/setting/system/member/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/admin_directory/setting/system/member/(?P<id>\\d+)/up$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/admin_directory/setting/system/member/(?P<id>\\d+)/down$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/admin_directory/setting/system/member/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/admin_directory/setting/system/security' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/admin_directory/setting/system/system')) {
                            // admin_setting_system_system
                            if ('/admin_directory/setting/system/system' === $pathinfo) {
                            ...
                            if ('/admin_directory/setting/system/system/phpinfo' === $pathinfo) {
                ...
                elseif (0 === strpos($pathinfo, '/admin_directory/shipping')) {
                    // admin_shipping_update_order_status
                    if (preg_match('#^/admin_directory/shipping/(?P<id>\\d+)/order_status$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/admin_directory/shipping/(?P<id>\\d+)/tracking_number$#sD', $pathinfo, $matches)) {
                    ...
                    // admin_shipping_edit
                    if (preg_match('#^/admin_directory/shipping/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                    ...
                    if (0 === strpos($pathinfo, '/admin_directory/shipping/preview_notify_mail') && preg_match('#^/admin_directory/shipping/preview_notify_mail/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                    ...
                    if (0 === strpos($pathinfo, '/admin_directory/shipping/notify_mail') && preg_match('#^/admin_directory/shipping/notify_mail/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                ...
                elseif (0 === strpos($pathinfo, '/admin_directory/store/plugin')) {
                    if (0 === strpos($pathinfo, '/admin_directory/store/plugin/api')) {
                        if (0 === strpos($pathinfo, '/admin_directory/store/plugin/api/search')) {
                            // admin_store_plugin_owners_search
                            if ('/admin_directory/store/plugin/api/search' === $pathinfo) {
                            ...
                            if (0 === strpos($pathinfo, '/admin_directory/store/plugin/api/search/page') && preg_match('#^/admin_directory/store/plugin/api/search/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/admin_directory/store/plugin/api/schema_update' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/admin_directory/store/plugin/api/install')) {
                            // admin_store_plugin_install_confirm
                            if (preg_match('#^/admin_directory/store/plugin/api/install/(?P<id>\\d+)/confirm$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/admin_directory/store/plugin/api/install' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/admin_directory/store/plugin/api/delete') && preg_match('#^/admin_directory/store/plugin/api/delete/(?P<id>\\d+)/uninstall$#sD', $pathinfo, $matches)) {
                        ...
                        if (0 === strpos($pathinfo, '/admin_directory/store/plugin/api/upgrade')) {
                            // admin_store_plugin_api_upgrade
                            if ('/admin_directory/store/plugin/api/upgrade' === $pathinfo) {
                            ...
                            if (preg_match('#^/admin_directory/store/plugin/api/upgrade/(?P<id>\\d+)/confirm$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/admin_directory/store/plugin/api/update' === $pathinfo) {
                    ...
                    // admin_store_plugin
                    if ('/admin_directory/store/plugin' === $pathinfo) {
                    ...
                    if (preg_match('#^/admin_directory/store/plugin/(?P<id>\\d+)/update$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/admin_directory/store/plugin/(?P<id>\\d+)/enable$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/admin_directory/store/plugin/(?P<id>\\d+)/disable$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/admin_directory/store/plugin/(?P<id>\\d+)/uninstall$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/admin_directory/store/plugin/install' === $pathinfo) {
                    ...
                    if ('/admin_directory/store/plugin/authentication_setting' === $pathinfo) {
                ...
                elseif (0 === strpos($pathinfo, '/admin_directory/store/template')) {
                    // admin_store_template
                    if ('/admin_directory/store/template' === $pathinfo) {
                    ...
                    if (preg_match('#^/admin_directory/store/template/(?P<id>\\d+)/download$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/admin_directory/store/template/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/admin_directory/store/template/install' === $pathinfo) {
            ...
            elseif (0 === strpos($pathinfo, '/admin_directory/c')) {
                // admin_change_password
                if ('/admin_directory/change_password' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/admin_directory/content')) {
                    if (0 === strpos($pathinfo, '/admin_directory/content/block')) {
                        // admin_content_block
                        if ('/admin_directory/content/block' === $pathinfo) {
                        ...
                        if ('/admin_directory/content/block/new' === $pathinfo) {
                        ...
                        if (preg_match('#^/admin_directory/content/block/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/admin_directory/content/block/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    // admin_content_cache
                    if ('/admin_directory/content/cache' === $pathinfo) {
                    ...
                    // admin_content_css
                    if ('/admin_directory/content/css' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/admin_directory/content/file_')) {
                        // admin_content_file
                        if ('/admin_directory/content/file_manager' === $pathinfo) {
                        ...
                        if ('/admin_directory/content/file_view' === $pathinfo) {
                        ...
                        if ('/admin_directory/content/file_delete' === $pathinfo) {
                        ...
                        if ('/admin_directory/content/file_download' === $pathinfo) {
                    ...
                    // admin_content_js
                    if ('/admin_directory/content/js' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/admin_directory/content/layout')) {
                        // admin_content_layout
                        if ('/admin_directory/content/layout' === $pathinfo) {
                        ...
                        if (preg_match('#^/admin_directory/content/layout/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/admin_directory/content/layout/new' === $pathinfo) {
                        ...
                        if (preg_match('#^/admin_directory/content/layout/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/admin_directory/content/layout/view_block' === $pathinfo) {
                        ...
                        if (preg_match('#^/admin_directory/content/layout/(?P<id>\\d+)/preview$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/admin_directory/content/maintenance' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/admin_directory/content/news')) {
                        // admin_content_news
                        if ('/admin_directory/content/news' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/admin_directory/content/news/page') && preg_match('#^/admin_directory/content/news/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/admin_directory/content/news/new' === $pathinfo) {
                        ...
                        if (preg_match('#^/admin_directory/content/news/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/admin_directory/content/news/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    elseif (0 === strpos($pathinfo, '/admin_directory/content/page')) {
                        // admin_content_page
                        if ('/admin_directory/content/page' === $pathinfo) {
                        ...
                        if ('/admin_directory/content/page/new' === $pathinfo) {
                        ...
                        if (preg_match('#^/admin_directory/content/page/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/admin_directory/content/page/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                ...
                elseif (0 === strpos($pathinfo, '/admin_directory/customer')) {
                    // admin_customer
                    if ('/admin_directory/customer' === $pathinfo) {
                    ...
                    // admin_customer_page
                    if (0 === strpos($pathinfo, '/admin_directory/customer/page') && preg_match('#^/admin_directory/customer/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/admin_directory/customer/(?P<id>\\d+)/resend$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/admin_directory/customer/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/admin_directory/customer/export' === $pathinfo) {
                    ...
                    if (preg_match('#^/admin_directory/customer/(?P<id>\\d+)/delivery/new$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/admin_directory/customer/(?P<id>\\d+)/delivery/(?P<did>\\d+)/edit$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/admin_directory/customer/(?P<id>\\d+)/delivery/(?P<did>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    // admin_customer_new
                    if ('/admin_directory/customer/new' === $pathinfo) {
                    ...
                    // admin_customer_edit
                    if (preg_match('#^/admin_directory/customer/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
            ...
            elseif (0 === strpos($pathinfo, '/admin_directory/order')) {
                // admin_shipping_csv_import
                if ('/admin_directory/order/shipping_csv_upload' === $pathinfo) {
                ...
                if ('/admin_directory/order/csv_template' === $pathinfo) {
                ...
                // admin_order_new
                if ('/admin_directory/order/new' === $pathinfo) {
                ...
                // admin_order_edit
                if (preg_match('#^/admin_directory/order/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                ...
                if (0 === strpos($pathinfo, '/admin_directory/order/search')) {
                    if (0 === strpos($pathinfo, '/admin_directory/order/search/customer/html')) {
                        // admin_order_search_customer_html
                        if ('/admin_directory/order/search/customer/html' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/admin_directory/order/search/customer/html/page') && preg_match('#^/admin_directory/order/search/customer/html/page(?:/(?P<page_no>[^/]++))?$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/admin_directory/order/search/customer/id' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/admin_directory/order/search/product')) {
                        // admin_order_search_product
                        if ('/admin_directory/order/search/product' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/admin_directory/order/search/product/page') && preg_match('#^/admin_directory/order/search/product/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/admin_directory/order/search/order_item_type' === $pathinfo) {
                ...
                // admin_order_mail
                if (preg_match('#^/admin_directory/order/(?P<id>\\d+)/mail$#sD', $pathinfo, $matches)) {
                ...
                if ('/admin_directory/order/mail/view' === $pathinfo) {
                ...
                // admin_order
                if ('/admin_directory/order' === $pathinfo) {
                ...
                // admin_order_page
                if (0 === strpos($pathinfo, '/admin_directory/order/page') && preg_match('#^/admin_directory/order/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                ...
                if ('/admin_directory/order/bulk_delete' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/admin_directory/order/export')) {
                    // admin_order_export_order
                    if ('/admin_directory/order/export/order' === $pathinfo) {
                    ...
                    if ('/admin_directory/order/export/shipping' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/admin_directory/order/export/pdf')) {
                        // admin_order_export_pdf
                        if ('/admin_directory/order/export/pdf' === $pathinfo) {
                        ...
                        if ('/admin_directory/order/export/pdf/download' === $pathinfo) {
            ...
            elseif (0 === strpos($pathinfo, '/admin_directory/product')) {
                if (0 === strpos($pathinfo, '/admin_directory/product/c')) {
                    if (0 === strpos($pathinfo, '/admin_directory/product/category')) {
                        // admin_product_category
                        if ('/admin_directory/product/category' === $pathinfo) {
                        ...
                        if (preg_match('#^/admin_directory/product/category(?:/(?P<parent_id>\\d+))?$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/admin_directory/product/category/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/admin_directory/product/category/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/admin_directory/product/category/sort_no/move' === $pathinfo) {
                        ...
                        if ('/admin_directory/product/category/export' === $pathinfo) {
                        ...
                        if ('/admin_directory/product/category_csv_upload' === $pathinfo) {
                    ...
                    elseif (0 === strpos($pathinfo, '/admin_directory/product/class_category')) {
                        // admin_product_class_category
                        if (preg_match('#^/admin_directory/product/class_category/(?P<class_name_id>\\d+)$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/admin_directory/product/class_category/(?P<class_name_id>\\d+)/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/admin_directory/product/class_category/(?P<class_name_id>\\d+)/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/admin_directory/product/class_category/(?P<class_name_id>\\d+)/(?P<id>\\d+)/visibility$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/admin_directory/product/class_category/sort_no/move' === $pathinfo) {
                    ...
                    elseif (0 === strpos($pathinfo, '/admin_directory/product/class_name')) {
                        // admin_product_class_name
                        if ('/admin_directory/product/class_name' === $pathinfo) {
                        ...
                        if (preg_match('#^/admin_directory/product/class_name/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/admin_directory/product/class_name/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/admin_directory/product/class_name/sort_no/move' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/admin_directory/product/csv_template') && preg_match('#^/admin_directory/product/csv_template/(?P<type>\\w+)$#sD', $pathinfo, $matches)) {
                ...
                if ('/admin_directory/product/product_csv_upload' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/admin_directory/product/product/class')) {
                    // admin_product_product_class
                    if (preg_match('#^/admin_directory/product/product/class/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/admin_directory/product/product/class/(?P<id>\\d+)/clear$#sD', $pathinfo, $matches)) {
                ...
                // admin_product
                if ('/admin_directory/product' === $pathinfo) {
                ...
                // admin_product_page
                if (0 === strpos($pathinfo, '/admin_directory/product/page') && preg_match('#^/admin_directory/product/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                ...
                if (0 === strpos($pathinfo, '/admin_directory/product/product')) {
                    // admin_product_image_add
                    if ('/admin_directory/product/product/image/add' === $pathinfo) {
                    ...
                    if ('/admin_directory/product/product/new' === $pathinfo) {
                    ...
                    if (preg_match('#^/admin_directory/product/product/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/admin_directory/product/product/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/admin_directory/product/product/(?P<id>\\d+)/copy$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/admin_directory/product/product/(?P<id>\\d+)/display$#sD', $pathinfo, $matches)) {
                ...
                if (0 === strpos($pathinfo, '/admin_directory/product/classes') && preg_match('#^/admin_directory/product/classes/(?P<id>\\d+)/load$#sD', $pathinfo, $matches)) {
                ...
                if ('/admin_directory/product/export' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/admin_directory/product/bulk/product-status') && preg_match('#^/admin_directory/product/bulk/product\\-status/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                ...
                if (0 === strpos($pathinfo, '/admin_directory/product/tag')) {
                    // admin_product_tag
                    if ('/admin_directory/product/tag' === $pathinfo) {
                    ...
                    if (preg_match('#^/admin_directory/product/tag/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/admin_directory/product/tag/sort_no/move' === $pathinfo) {
            ...
            // admin_logout
            if ('/admin_directory/logout' === $pathinfo) {
