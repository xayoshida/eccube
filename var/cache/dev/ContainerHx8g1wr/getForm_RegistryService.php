...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(['Eccube\\Form\\Type\\AddCartType' => function () {
...
}, 'Plugin\\Sample\\Form\\Type\\Admin\\ConfigType' => function () {
    return ${($_ = isset($this->services['Plugin\\Sample\\Form\\Type\\Admin\\ConfigType']) ? $this->services['Plugin\\Sample\\Form\\Type\\Admin\\ConfigType'] : ($this->services['Plugin\\Sample\\Form\\Type\\Admin\\ConfigType'] = new \Plugin\Sample\Form\Type\Admin\ConfigType())) && false ?: '_'};
}, 'Plugin\\Sample\\Form\\Type\\Admin\\CustomerRankType' => function () {
    return ${($_ = isset($this->services['Plugin\\Sample\\Form\\Type\\Admin\\CustomerRankType']) ? $this->services['Plugin\\Sample\\Form\\Type\\Admin\\CustomerRankType'] : ($this->services['Plugin\\Sample\\Form\\Type\\Admin\\CustomerRankType'] = new \Plugin\Sample\Form\Type\Admin\CustomerRankType())) && false ?: '_'};
    ...
    yield 0 => ${($_ = isset($this->services['Plugin\\Sample\\Form\\Extension\\CustomerTypeExtension']) ? $this->services['Plugin\\Sample\\Form\\Extension\\CustomerTypeExtension'] : ($this->services['Plugin\\Sample\\Form\\Extension\\CustomerTypeExtension'] = new \Plugin\Sample\Form\Extension\CustomerTypeExtension())) && false ?: '_'};
}, 1), 'Eccube\\Form\\Type\\Front\\EntryType' => new RewindableGenerator(function () {
    yield 0 => ${($_ = isset($this->services['Plugin\\Sample\\Form\\Extension\\EntryTypeExtension']) ? $this->services['Plugin\\Sample\\Form\\Extension\\EntryTypeExtension'] : ($this->services['Plugin\\Sample\\Form\\Extension\\EntryTypeExtension'] = new \Plugin\Sample\Form\Extension\EntryTypeExtension())) && false ?: '_'};
